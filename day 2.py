...
# num = 10
# num = num + 10  #10+10 --> 20
# num += 10 (same meaning with the upper sentence)

# num = num - 10  #10-10 --> 0
# num -= 10 (same meaning with the upper sentence)

# num = num * 10  #10*10 --> 100
# num *= 10 (same meaning with the upper sentence)
...
# num = num % 10  #10%10 --> 0
# num %= 10 (same meaning with the upper sentence) (modular/reminder)

# num = num ** 10  #10**10 --> 10000000000
# num **= 10 (same meaning with the upper sentence) (power)
