...
def greet(name, message="Welcome!"):
    # A simple f-string is usually the most readable way to handle this
    print(f"Hello, {name}! {message}")
greet("Rajesh")
greet("Sunita", "Good morning!")
...
def user_profile(name, age=18, *hobbies, **extra_info):
    ...
    if extra_info:
        for k, v in extra_info.items():
            print(f"{k}: {v}")
user_profile("Rajesh", 25, "Coding", "Hiking", "Reading", email="rajesh@email.com", job="Dev")